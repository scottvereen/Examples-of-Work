...
using System.Data.SqlClient; //Connects to Database
using System.Data;    
...
namespace SuperHero
{
    public class Hero
    {
        ...
        //Allowes Search for heros by first last
        ...
        //Allow A spacific search for a person
        ...
        public Int32 DeleteOnePerson(int intHero_ID)
        {
            Int32 intRecords = 0;
        ...
        //allows to use a vaiouse versions
        ...
        public Int32 UpdateAContact()
        {
            ...
            string strSQL = "UPDATE Hero SET fName = @FName, lName = @LName, origin = @Origin, ability 1 = @Ability1,ability2 = @Ability2, ability3 = @Ability3,email = @Email WHERE Hero_ID = @Hero_ID;";
